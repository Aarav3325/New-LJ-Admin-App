...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category","CE", "CSE", "CSE(AI-ML)", "IT"};
        addTeacherCategory.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_selectable_list_item, items));
